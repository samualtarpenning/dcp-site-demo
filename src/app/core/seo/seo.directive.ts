    ...
    this._routerSubscription = this.router.events
      ...
      .subscribe(event => {
        if (event['data'] && event['data'].seo) {
          ...
          const title = seo_data.title ? seo_data.title : 'Deep Cleaner';
          const description = seo_data.description ? seo_data.description : 'Cleaning Service';
          const keywords = seo_data.keywords ? seo_data.keywords : 'Cleaning, Maids, organizing, household, home, time, deep cleaning';
